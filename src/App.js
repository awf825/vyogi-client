    ...
    <BrowserRouter>
      <div className="App">
        <Switch>
          ...
          <Route exact path="/registration/login" component={RegistrationLogin}/>
          <Route exact path="/registration/signup" component={RegistrationSignUp}/>
          <Route exact path="/video" render={(props) => <Video {...props} />} />
          <Route eact path="/schedule" render={(props) => <Schedule {...props} />}/>
        </Switch>
      </div>
    </BrowserRouter>
  );

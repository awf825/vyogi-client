  ...
  return (
    <div className="about">
      <div className="about__main">
        ...
        and this time it really stuck! I decided that yoga had such a 
        positive impact on her wellbeing that I had to share with others. 
        Last year I headed to the Kripalu Center to get her 200 hour 
        certification, drawn to the Kripalu style due to its emphasis 
        on compassion and inclusiveness. I believe yoga is truly for 
        everybody regardless of size, age, background, or athletic ability 
        ...
        When I’m not practicing yoga, you can find me cooking, reading, 
